...
- 在 src 目录下，新建 views 文件夹,新建home.vue与layout文件夹存放具体的页面
...
### 4. 修改App.vue 添加home.vue与 layout 配置 router-view
...
- 修改下layout/index.vue文件 页面添加跳转链接
...
- 在tsconfig.json文件中compilerOptions添加如下配置 去除vscode红色下划线(并不影响编译)
